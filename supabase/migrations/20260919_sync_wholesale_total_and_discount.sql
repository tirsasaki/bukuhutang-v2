...
begin
  ...
  loop
    ...
    if item_name = '' or item_qty <= 0 or retail_price <= 0 or item_discount < 0 or item_discount >= item_qty::bigint * selected_price then
      raise exception 'Lengkapi nama barang, jumlah, harga eceran, dan diskon setiap barang';
    end if;
