...
export default function Home() {
  ...
  useEffect(() => {
    ...
    register({ name: "record_payment", title: "Catat pembayaran", description: "Mencatat pembayaran sebagian atau melunasi seluruh piutang. Pembayaran dialokasikan ke piutang tertua terlebih dahulu.", inputSchema: { type: "object", properties: { customerId: { type: "string" }, amount: { type: "number" }, receivedBy: { type: "string" }, payAll: { type: "boolean" } }, required: ["customerId", "receivedBy"], additionalProperties: false }, annotations: { readOnlyHint: false, untrustedContentHint: false }, execute: async (input: Record<string, unknown>) => postAction({ action: "create_payment", ...input }) });
