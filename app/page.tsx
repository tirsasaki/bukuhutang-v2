...
import { ArrowDownToLine, BookOpenText, CheckCircle2, ChevronRight, CircleDollarSign, Clock3, Loader2, Plus, Search, Settings2, UploadCloud, UserPlus, WalletCards } from "lucide-react";
...
export default function Home() {
  ...
  async function submitForm(event: React.FormEvent<HTMLFormElement>, action: string, close: () => void) {
    ...
    try {
      ...
      toast.success(action === "create_payment" ? "Pembayaran tersimpan." : action === "create_debt" ? "Piutang baru tersimpan." : "Pelanggan ditambahkan.");
      close();
